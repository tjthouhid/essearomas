...
<?php endif; ?>
		...
		<form class="woocommerce-form woocommerce-form-login login" method="post">
			<h2><?php esc_html_e( 'I ALREADY HAVE AN ACCOUNT HERE', 'woocommerce' ); ?></h2>
...
<?php if ( get_option( 'woocommerce_enable_myaccount_registration' ) === 'yes' ) : ?>
	...
	<div class="u-column2 col-2">
		...
		<form method="post" class="register">
			...
			<p class="woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide">
				<label for="cust_type"><?php esc_html_e( 'Customer Type', 'woocommerce' ); ?></label>
				<select class="woocommerce-Input woocommerce-Input--text input-text form-control" name="cust_type" id="cust_type">
					<option value="customer">Reguar Customer</option>
					<option value="whole-sale">Whole Sale Customer</option>
				</select>
				
			</p>
			<p class="woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide company-name-p hidden">
				<label for="company_name"><?php esc_html_e( 'Company Name', 'woocommerce' ); ?></label>
				
				<input type="text" class="woocommerce-Input woocommerce-Input--text input-text" name="company_name" id="company_name" value="<?php echo ( ! empty( $_POST['company_name'] ) ) ? esc_attr( wp_unslash( $_POST['company_name'] ) ) : ''; ?>" /><?php // @codingStandardsIgnoreLine ?>
