			...
			<tbody>
				...
				<tr>
					<td colspan="6" class="actions">
						...
						<button type="submit" class="button cart_update_checkout" name="update_cart" style="display:none" value="<?php esc_attr_e( 'Update cart', 'woocommerce' ); ?>"><?php esc_html_e( 'Update Shopping Cart', 'woocommerce' ); ?></button>
